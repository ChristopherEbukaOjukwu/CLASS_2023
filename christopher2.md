...
``` r
#this gets the name of unique dps
...
new_filenames <- paste0("my_results/my_consensus_peaks/", names(peaks), "_consensus.bed")
...
knitr::include_graphics("/scratch/Shares/rinnclass/CLASS_2023/Christopher/CLASS_2023/CLASSES/my_results/uscs_screenshot.jpg")
```

<img src="my_results/uscs_screenshot.jpg" width="1920" />

``` r
#The peaks from my proteins are similar to the analysis from previous years.
```
...
to bind near promoters (maybe a little too suspiciously).
...
write_csv(num_peaks_df, "my_results/num_peaks_df.csv")
```
...
pc_table <- table(peak_occurence_df$number_of_dbp)
pc <- table 
```
...
24271 5895 5363 1270 15 The max number of proteins on a promoter is 4
...
num_peaks_df <- read_csv('my_results/num_peaks_df.csv')
```
...
![](christopher2_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](christopher2_files/figure-gfm/none%20of%20my%20proteins%20are%20TF-1.png)<!-- -->
...
![](christopher2_files/figure-gfm/none%20of%20my%20proteins%20are%20TF-2.png)<!-- -->
...
![](christopher2_files/figure-gfm/none%20of%20my%20proteins%20are%20TF-3.png)<!-- -->
...
![](christopher2_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](christopher2_files/figure-gfm/unnamed-chunk-7-2.png)<!-- -->
...
![](christopher2_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](christopher2_files/figure-gfm/unnamed-chunk-8-2.png)<!-- -->
...
![](christopher2_files/figure-gfm/unnamed-chunk-8-3.png)<!-- -->
